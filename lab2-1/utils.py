...
# === Env & Clients ===
load_dotenv()
openai_api_key = os.getenv("OPENAI_API_KEY")  # replace with your actual env var name if different
anthropic_api_key = os.getenv("ANTHROPIC_API_KEY")  # replace with your actual env var name if different
